...
def render(spec: "ArchSpec") -> str:
    ...
    for c in spec.components:
        ...
        comp: dict[str, Any] = {
            ...
            "properties": [
                {"name": "cloudwright:provider", "value": c.provider},
                {"name": "cloudwright:tier", "value": str(c.tier)},
                {"name": "cloudwright:region", "value": spec.region},
                {"name": "cloudwright:label", "value": c.label},
            ],
        }
        if c.description:
